...
In order for the bot to function (whether through the Coinbase Sandbox API or an actual account), you must create a Secret Key and save it to a file called 'auth_credentials.py'
